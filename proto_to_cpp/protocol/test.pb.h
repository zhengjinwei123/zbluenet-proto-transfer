...
extern S2CLoginRepDefaultTypeInternal _S2CLoginRep_default_instance_;
}  // namespace protocol
PROTOBUF_NAMESPACE_OPEN
template<> ::protocol::C2SLoginReq* Arena::CreateMaybeMessage<::protocol::C2SLoginReq>(Arena*);
template<> ::protocol::S2CLoginRep* Arena::CreateMaybeMessage<::protocol::S2CLoginRep>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace protocol {
...
class S2CLoginRep final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protocol.S2CLoginRep) */ {
 public:
  inline S2CLoginRep() : S2CLoginRep(nullptr) {}
  ~S2CLoginRep() override;
  explicit constexpr S2CLoginRep(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  S2CLoginRep(const S2CLoginRep& from);
  S2CLoginRep(S2CLoginRep&& from) noexcept
    : S2CLoginRep() {
    *this = ::std::move(from);
  }

  inline S2CLoginRep& operator=(const S2CLoginRep& from) {
    CopyFrom(from);
    return *this;
  }
  inline S2CLoginRep& operator=(S2CLoginRep&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()) {
      InternalSwap(&from);
    } else {
  ...
  static const S2CLoginRep& default_instance() {
    return *internal_default_instance();
  }
  static inline const S2CLoginRep* internal_default_instance() {
    return reinterpret_cast<const S2CLoginRep*>(
               &_S2CLoginRep_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(S2CLoginRep& a, S2CLoginRep& b) {
    a.Swap(&b);
  }
  inline void Swap(S2CLoginRep* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(S2CLoginRep* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline S2CLoginRep* New() const final {
    return new S2CLoginRep();
  }

  S2CLoginRep* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<S2CLoginRep>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const S2CLoginRep& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const S2CLoginRep& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message*to, const ::PROTOBUF_NAMESPACE_ID::Message&from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(S2CLoginRep* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "protocol.S2CLoginRep";
  }
  protected:
  explicit S2CLoginRep(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  // @@protoc_insertion_point(class_scope:protocol.S2CLoginRep)
 private:
  class _Internal;
...
// optional int32 ret = 1;
inline bool S2CLoginRep::_internal_has_ret() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool S2CLoginRep::has_ret() const {
  return _internal_has_ret();
}
inline void S2CLoginRep::clear_ret() {
  ret_ = 0;
  _has_bits_[0] &= ~0x00000001u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 S2CLoginRep::_internal_ret() const {
  return ret_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 S2CLoginRep::ret() const {
  // @@protoc_insertion_point(field_get:protocol.S2CLoginRep.ret)
  return _internal_ret();
}
inline void S2CLoginRep::_internal_set_ret(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000001u;
  ret_ = value;
}
inline void S2CLoginRep::set_ret(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_ret(value);
  // @@protoc_insertion_point(field_set:protocol.S2CLoginRep.ret)
}
