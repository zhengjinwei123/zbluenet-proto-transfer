...
#include <zbluenet/demo/proto/c2s.pb.h>
...
template<>
struct C2SMessageType::id< C2SLoginReq> {
	static const int value = protocol::C2S_LOGIN_REQ;
};

template<>
struct C2SMessageType::id< S2CLoginResp> {
	static const int value = protocol::S2C_LOGIN_RESP;
};

template<>
struct C2SMessageType::id< C2SLogoutReq> {
	static const int value = protocol::C2S_LOGOUT_REQ;
};

template<>
struct C2SMessageType::id< S2CLogoutResp> {
